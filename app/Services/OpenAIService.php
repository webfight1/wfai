...
class OpenAIService
{
    ...
    - Show EXACTLY the number of items user asks for (e.g., if user asks for X, show X). If no specific number given and there are too many items, then show max 10
